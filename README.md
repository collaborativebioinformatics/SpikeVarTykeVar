...
* MOD_BAM have the alignments generated by mapping the modified reads against the reference.
* --primary ensures that only primaary alignments are merged back into the dataset.
